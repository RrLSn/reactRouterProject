...
const Purpose = () => {
  return (
    ...
    <div className='bg-[#e8d6d5] w-[98.7vw] h-[120vh]'>
      <NavBar />

      <div className='flex mt-[3rem] px-[5rem] gap-[2rem] w-[100%] h-[90vh]'>
        <div className='flex flex-col place-content-center purpose-hero'>
